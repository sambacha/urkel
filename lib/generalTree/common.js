...
function hashInternal(hash, prefix, left, right) {
  if (prefix.size === 0) return hash.multi(INTERNAL_PREFIX, left, right);
...
function readUNBytes(data, off, n) {
  let total = 0;
  let i = 0;
  let mul = 1;
  while (i < n) {
...
exports.writeUNBytes = writeUNBytes;
exports.readUNBytes = readUNBytes;
